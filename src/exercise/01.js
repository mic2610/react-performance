  ...
  return (
      ...
      >
        <label
          ...
          // One way to load in the whole globe
          // onMouseEnter={e => setShowGlobe(true)}
          // onMouseLeave={e => setShowGlobe(false)}

          onMouseEnter={loadGlobeAssets}
          onMouseLeave={loadGlobeAssets}
